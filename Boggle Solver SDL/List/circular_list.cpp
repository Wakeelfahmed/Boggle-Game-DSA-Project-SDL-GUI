...
void circular_list::insert_beg(COORD v) {
...
void circular_list::insert_specfic_Position(int Position, COORD newvalue) {
...
void circular_list::insert_after(COORD oldvalue, COORD newvalue) {
	Node* p = head;
	if (isEmpty())
		return;
	do
...
void circular_list::insert_end(COORD value) {
...
int Search_in_List(COORD Value_to_search, circular_list& list) {
...
void circular_list::delete_Node(COORD Value_to_delete) {
	if (isEmpty()) {
		cout << "List is Empty\n"; return;
	}
